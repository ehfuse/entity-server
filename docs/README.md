...
- MySQL·PostgreSQL·MongoDB 등 다양한 DB와 인증·알림·결제 프로바이더를 지원하여 유연한 시스템 구성이 가능하며, API 게이트웨이 분리 구조에서도 비즈니스 로직만 간결하게 구현할 수 있습니다.
...
| [2FA (2단계 인증)](security/2fa-guide.md)                     | TOTP 기반 앱 인증, 복구 코드 관리              |
| [PG 결제](extensions/pg-guide.md)                             | 온라인 결제 게이트웨이 연동 (예정)             |
...
- [이메일 인증 · 비밀번호](security/password-guide.md)
