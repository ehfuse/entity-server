...
flowchart TB
        ...
        API_A --> DEF["db_group: default<br/>MySQL / MariaDB / TiDB / PostgreSQL / SQLite"]
...
flowchart TB
        ...
        API_B --> DEF["db_group: default<br/>MySQL / MariaDB / TiDB / PostgreSQL / SQLite"]
...
- `X-Transaction-ID` 헤더로 여러 요청을 하나의 revision 그룹으로 묶기 가능 → [History · Revision](../data/history-revision-guide.md)
...
- 비SQL 스토리지는 현재 MongoDB만 지원 (DataStore 인터페이스) — DynamoDB/Firestore 등은 확장점으로 예약
