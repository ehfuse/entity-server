...
>   상세 내용은 [History · Revision · Rollback 가이드](../guides/data/history-revision-guide.md)를 참조하세요.
...
> 롤백 메커니즘 상세는 [History · Revision · Rollback 가이드](../guides/data/history-revision-guide.md)를 참조하세요.
...
- [History · Revision · Rollback 가이드](../guides/data/history-revision-guide.md) - 스냅샷 저장 시점, 트랜잭션 ID 활용, 롤백 동작 원리
