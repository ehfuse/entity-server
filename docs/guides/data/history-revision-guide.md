...
- [entity-routes.md](../../api-routes/entity-routes.md) — 엔티티 API 전체 목록
- [entity-config-guide.md](entity-config-guide.md) — `history_ttl` 설정
- [architecture-deployment.md](../setup/architecture-deployment.md) — 3-테이블 구조 및 데이터 모델
- [security.md](../security/security.md) — `entity:history`, `entity:rollback` RBAC 권한
