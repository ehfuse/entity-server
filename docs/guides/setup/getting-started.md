...
> 배포용 문서 전체 흐름은 [배포용 가이드 맵](../README.md)에서 확인하세요.

## 빠른 시작 체크리스트

| #   | 단계                 | 설명                                                        | 참고 문서                                                                                         |
| --- | -------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| 1   | **아키텍처 이해**    | 시스템 구성, 데이터 모델, 클라이언트 연동 패턴 파악         | [Architecture](architecture-deployment.md)                                                        |
...
| 9   | **인증 설정**        | JWT / HMAC / OAuth 2.0 설정 및 인증 흐름 확인               | [Auth Guide](../security/auth-guide.md) · [Security](../security/security.md)                     |
| 10  | **API 목록**         | 엔티티 CRUD·조회·필터 API 엔드포인트 확인                   | [Entity Routes](../../api-routes/entity-routes.md) · [API Routes](../../api-routes/api-routes.md) |
| 11  | **조인 방법**        | 엔티티 간 관계 및 join 쿼리 패턴                            | [Join Guide](../data/join-guide.md)                                                               |
...
- [Entity Config Guide](../data/entity-config-guide.md)
