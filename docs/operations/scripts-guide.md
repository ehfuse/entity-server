...
| 모드     | 동작                                                                                                                                                                                                                                  |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dev`    | `configs/server.json.environment=development`로 맞춘 뒤, `configs/database.json.default`는 그대로 유지하고 `bin/entity-server`를 포그라운드 실행                                                                                      |
...
| 옵션 직접 지정 | `./service-install.sh --user=<user> --group=<group>` |
| 시작 생략      | `./service-install.sh --no-start`                    |
