...
`configs/notification/smtp.json`:
...
> `configs/notification/smtp.json` 파일이 없으면 SMTP 기능이 비활성화됩니다. Push 알림과 마찬가지로 **선택적 기능**입니다.
        ...
        "after_insert": [
            {
                ...
                "template_name": "order/order_confirmation",
...
│   └── welcome.html                  ← 환영 메일
├── account/
│   ├── dormancy_warning.html         ← 휴면 예정 경고
│   └── password_expiry_warning.html  ← 비밀번호 만료 경고
├── backup/
