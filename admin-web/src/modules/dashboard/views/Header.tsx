...
const getHeaderTitle = (pathname: string) => {
    ...
    if (pathname.startsWith("/erd-mermaid")) return "ERD";
    if (pathname.startsWith("/erd")) return "ERD";
    if (pathname.startsWith("/help")) return "도움말";
    if (pathname.startsWith("/ocr")) return "OCR 문서 인식";
    if (pathname.startsWith("/llm/documents")) return "RAG 문서 관리";
    if (pathname.startsWith("/llm/conversations")) return "대화 내역";
    if (pathname.startsWith("/llm/usage")) return "LLM 사용량";
    if (pathname.startsWith("/llm/providers")) return "프로바이더 관리";
    if (pathname.startsWith("/llm")) return "LLM 관리";
    return "";
};
